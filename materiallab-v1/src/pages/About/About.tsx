...
import { MLHeading, MLText, MLHero, MLDisplay } from '../../components/ML';
    ...
    <Layout>
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <MLHero className="mb-8 text-text">
              About Material Lab
            </MLHero>
            <MLText variant="bodyXL" className="text-text-weak max-w-2xl mx-auto" brandVoice="thoughtful-expert">
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <MLDisplay size={2} className="mb-8 text-text" brandVoice="compelling-presenter">
                Our Mission
              </MLDisplay>
              <MLText variant="bodyL" className="text-text-weak mb-6" brandVoice="thoughtful-expert">
              ...
              <MLText variant="bodyL" className="text-text-weak" brandVoice="thoughtful-expert">
      ...
      <section className="py-20">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <MLDisplay size={2} className="mb-6 text-text" brandVoice="compelling-presenter">
              Our Values
            </MLDisplay>
            <MLText variant="bodyXL" className="text-text-weak max-w-2xl mx-auto" brandVoice="thoughtful-expert">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {[
              ...
              >
                <MLHeading level={3} className="mb-4 text-text" brandVoice="compelling-presenter">
                  {value.title}
                </MLHeading>
                <MLText variant="body" className="text-text-weak" brandVoice="thoughtful-expert">
                  {value.description}
                </MLText>
              </motion.div>
            ))}
